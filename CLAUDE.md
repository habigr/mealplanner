...
STATE: **v138 is LIVE** (color-scheme header — replaced the entire photo-banner system, NO photos; verified locally + regression 25/25, pushed 2026-06-27). ⚠️ The `banner-wip` branch (photo shared-gallery #28) is **OBSOLETE — do NOT ship it** (superseded; delete the branch eventually). Backup tag **`pre-v138-photo-removal`** = one-command rollback if anything surfaces on the live site.
